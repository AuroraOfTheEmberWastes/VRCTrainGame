Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/58aa9b34e4deefe46bcf6d082150554d"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyFlipbook(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				{
					if ((7.0 /*_FlipbookFPS*/) != 0)
					{
						currentFrame = ((_Time.y / (1 / (7.0 /*_FlipbookFPS*/))) + (0.0 /*_FlipbookFrameOffset*/)) % totalFrames;
						if ((0.0 /*_FlipbookStartAndEnd*/))
						{
				...
				{
					flipBookPixel.rgb = poiThemeColor(poiMods, float4(1,1,1,0.8588235).rgb, (0.0 /*_FlipbookColorThemeIndex*/));
				}
				else
				{
					flipBookPixel.rgb *= poiThemeColor(poiMods, float4(1,1,1,0.8588235).rgb, (0.0 /*_FlipbookColorThemeIndex*/));
				...
				{
					flipBookPixel.rgb = hueShift(flipBookPixel.rgb, (0.0 /*_FlipbookHueShift*/) + _Time.x * (0.0 /*_FlipbookHueShiftSpeed*/), (1.0 /*_FlipbookHueShiftColorSpace*/));
				}
				...
				poiFragData.baseColor = lerp(poiFragData.baseColor.rgb, customBlend(poiFragData.baseColor.rgb, flipBookPixel.rgb, (0.0 /*_FlipbookBlendType*/)), flipBookPixel.a * float4(1,1,1,0.8588235).a * (1.0 /*_FlipbookReplace*/) * flipBookMask * flipbookAlpha);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float2 mainUV = poiUV(poiMesh.uv[(0.0 /*_MainTexUV*/)].xy, float4(2,6.5,0,0));
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.03820433,0.3094689,0.3094689,0.772549).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.03820433,0.3094689,0.3094689,0.772549).a;
				#if defined(PROP_ALPHAMASK) || !defined(OPTIMIZER_ENABLED)
